...
#include <QtMath>
#include"redtower.h"
const QSize RedTower::ms_fixedSize(355, 200);

RedTower::RedTower(QPoint pos, MainWindow *game, const QPixmap &sprite/* = QPixmap(":/image/magictower.png"*/)
    : m_attacking(false)
    , m_attackRange(300)
    , m_damage(10)
    , m_fireRate(1000)
...
void RedTower::checkEnemyInRange()
{
    if (m_chooseEnemy)
    {
        // 这种情况下,需要旋转炮台对准敌人
...
void RedTower::draw(QPainter *painter) const
{
    painter->save();
...
void RedTower::attackEnemy()
{
    m_fireRateTimer->start(m_fireRate);
}

void RedTower::chooseEnemyForAttack(Enemy *enemy)
{
    m_chooseEnemy = enemy;
    attackEnemy();
...
void RedTower::lostSightOfEnemy()
{
